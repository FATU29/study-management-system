          ...
          {/* User Info */}
            ...
            <div className="relative">
                ...
                <div
                  ...
                  className={`z-10 ${isDropdownOpen ? '' : 'hidden'} mt-1 absolute right-0 bg-white divide-y divide-gray-100 rounded-lg shadow w-60 dark:bg-gray-700 dark:divide-gray-600`}>
                  <div className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformationButton">
                    <div>
                      <Button>
                        <Typography fontSize={"100%"} style={{textTransform: 'none'}} className="block no-underline px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Bảng tin</Typography>
                      </Button>
                    </div>
                    <div>
                      <Button>
                        <Typography fontSize={"100%"} style={{textTransform: 'none'}} className="block no-underline px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Cài đặt</Typography>
                      </Button>
                    </div>
                    <div>
                      <Button onClick={() => setModalIsOpen(true)}>
                        <Typography fontSize={"100%"} style={{textTransform: 'none'}} className="block no-underline px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" >Thông tin cá nhân</Typography>
                      </Button>
                    </div>
                  </div>
                  <div className="py-2">
                    <Button>
                      <Typography fontSize={"100%"} style={{textTransform: 'none', color:'red'}} onClick={() => logout()} className="block no-underline px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Thoát</Typography>
                    </Button>
                  </div>
                </div>
              </div>
