...
const MainDrive: React.FC = () => {
    const [files, setFiles] = useState<File[]>([
        { id: '1', name: 'File 1', dateModified: new Date(), url: 'https://example.com/file1' },
        { id: '2', name: 'File 2', dateModified: new Date(), url: 'https://example.com/file2' }
    ]);
                    ...
                    <tbody className=''>
                        {files.map(file => (
                            <tr key={file.id}>
                                ...
                                <td className="py-2 px-4 border-b">{file.dateModified.toLocaleString()}</td>
